<template>
  ...
  <bread-crumb
    ...
    description="Below are details of our privacy policy"
  />
  <!--BreadCrumb Ends-->
  <!--Resources Page-->
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-11">
          ...
          <p>
            We value the trust you place in evonexpay.com. That's why we insist
            ...
            about our information gathering and dissemination practices. Note:
          ...
          <ol>
            ...
            <p>
              ...
              with evonexpay.com. While you can browse some sections of our site
              without being a registered member, certain activities (such as
              ecurrency swap, trading etc) do require registration. We do use
              your contact information to send you offers based on your previous
              orders and your interests.
            </p>
            <li>Use of Demographic and Profile Data</li>
            <p>
              We use personal information to provide the services you request.
              To the extent we use your personal information to connect people
              ...
              information (like location, local government area, or age). We use
              this data to tailor your experience at our site, providing you
            ...
            <p>
              ...
              information specific to a given user. evonexpay.com places both
              permanent and temporary cookies in your computer's hard drive.
              evonexpay.com cookies do not contain any of your personally
            ...
            <p>
              <RouterLink to="/">Evonexpay.com</RouterLink> and its affiliates
              ...
              be acquired by that business entity. Should such a transaction
              occur, that other business entity (or the new combined entity)
            ...
            <p>
              ...
              identifiable information about you. evonexpay.com is not
            ...
            <p>
              <RouterLink to="/">Evonexpay.com</RouterLink> provides all users
              with the opportunity to opt-out of receiving non-essential
              (promotional, marketing-related) communications from us on behalf
              of our partners, and from us in general, after setting up an
              account. If you want to remove your contact information from all
              evonexpay.com lists and newsletters. In the future, you can
              unsubscribe by clicking the one-click unsubscribe button located
