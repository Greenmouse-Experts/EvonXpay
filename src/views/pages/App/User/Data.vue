        ...
        <div class="col-xxl-6 mb-30">
          <div class="card card-statistics h-100 mb-0">
            ...
            <div class="card-body pt-0">
              ...
              <div class="mt-2 mb-3">
                ...
                <div class="input-group">
                  ...
                  >
                    ...
                    <option value="BIL108">Mtn</option>
                    <option value="BIL110">Airtel</option>
                    <option value="BIL111">9mobile</option>
                  </select>
                </div>
              </div>
              <div class="mt-2 mb-3" v-if="dataBundles.length > 0">
                <label class="text-dark">Bundle</label>
                <div class="input-group">
                  <select
                    v-model="bundle"
                    @change="selectBundle"
              ...
              <div class="mt-2 mb-3" v-if="bundlePrice.length > 0">
...
export default {
  ...
  setup() {
    ...
    const bundle = ref("");
    const dataBundles = ref([]);
    const bundlePrice = ref([]);
    ...
    const selectDataProvider = () => {
      //console.log(provider.value, dataProvider.value);
      const bundles = dataProvider.value.filter(
        (item) => item.biller_code == provider.value
      );
      //console.log(dataProvider.value);
      dataBundles.value = bundles;
    };
    const selectBundle = () => {
      validating.value = true;
      const amountCharge = dataProvider.value.filter(
        (item) => item.item_code == bundle.value
      );
      bundlePrice.value = amountCharge;
      bundleAmount.value = amountCharge[0].amount;
